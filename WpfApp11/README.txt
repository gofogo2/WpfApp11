...
[진행중] 전체적으로 팝업 페이지에서 esc누르면 창 닫기(ftp 제외)
...
[V]우클릭 콘텍스트 메뉴 UI 구현
[] 전반적인 UX 적용
[] 파일 수정 / 삭제 시 특정파일이 선택되어있어야가능
[] 디바이스 타입 콤보박스 오류 수정
[] 디바이스 수정 팝업 오류 수정
[] relay 기능 업데이트
[] pdu 기능 업데이트
[] relay 전원관리 테스트 및 업데이트
[] pdu 전원관리 테스트 및 업데이트
[] 전체 전원관리 파워 온
[] 전체 전원관리 파워 오프
[] 전체 전원관리 프로그래스 바 수정
[] 상태 체크하는 딜레이 시간 config로 빼기
...
[ ] pdu 인덱스 처리 on / off /// 즉시 on_immediate // off_immediate
각각 제어할떄는 outlet
전체는 device
