...
#2024-08-22
[] 그리드에 아이템 없는 부분 우클릭 시 기기 추가/삭제 메뉴
[] 그리드에 아이템 없는 부분 더블클릭시 기기 추가 페이지열기
[] 전체적으로 팝업 페이지에서 esc누르면 창 닫기(ftp 제외)
[] itemConfig.json,schedule.json,settings.json 없을 때 기본으로 생성하고 예외처리
[] 맥어드레스 예외처리 (숫자랑 알파벳만 12자리 가능하게) ex)000000000000 ex)F02ER3V1123R3E
[] (보류)아이콘 적용
